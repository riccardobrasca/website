...
Recently, I have become interested in formal proofs and proof assistants, especially [Lean](https://leanprover.github.io/) and its [Mathematical Library](https://leanprover-community.github.io/). I actively participate to the [Liquid Tensor Experiment](https://github.com/leanprover-community/lean-liquid/). If you want to try to formalize some mathematics, I strongly suggest to try the [Natural Number Game](https://wwwf.imperial.ac.uk/~buzzard/xena/natural_number_game/).
